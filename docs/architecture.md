...
- Duplicate email or PRC license number returns `409`; a successful verification returns the PostgreSQL-issued JWT and the doctor proceeds to `/doctor/dashboard`.
